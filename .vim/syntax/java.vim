...
syn keyword javaType        List ArrayList LinkedList Set HashSet LinkedHashSet TreeSet Map HashMap TreeMap WeakHashMap LinkedHashMap IdentityHashMap
syn keyword javaType        Vector Stack Dictionary Hashtable Properties BitSet Iterator
